                                           ...
                                           <img src="{{asset('/')}}{{$product->image}}" alt="" style="width:100%; height:200px;">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{url('/product-details',['id'=>$product->id])}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                            </div>
                                        </div>
...
{{--                                        <div class="item-info-product text-center border-top mt-4">--}}
{{--                                            <h4 class="pt-1">--}}
{{--                                                <a href="{{url('/single')}}">Apple iPhone X</a>--}}
{{--                                            </h4>--}}
{{--                                            <div class="info-product-price my-2">--}}
...
{{--                                                <li>--}}
{{--                                                    <a href="{{url('/', ['id'=>$brand->id, 'type'=>'brand'])}}">{{$brand->name}}</a>--}}
{{--                                                </li>--}}
{{--                                            @endforeach--}}
                                            <img src="{{asset('/')}}/front-end/images/m4.jpg" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{url('/single')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{url('/single')}}">Sony 80 cm (32 inches)</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                ...
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/')}}/front-end/images/m5.jpg" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{url('/single')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{url('/single')}}">Artis Speaker</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                ...
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/')}}/front-end/images/m6.jpg" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{url('/single')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{url('/single')}}">Philips Speakers</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                        ...
                        <div class="product-sec1 product-sec2 px-sm-5 px-3">
                            <div class="row">
                                ...
                                <div class="col-md-8 bg-right-nut">
                                    <img src="{{asset('/')}}/front-end/images/image1.png" alt="">
                                </div>
                            </div>
                        </div>
                        <!-- //third section -->
                        ...
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mt-4">
                            ...
                            <div class="row">
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/')}}/front-end/images/m7.jpg" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{url('/single')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{url('/single')}}">Whirlpool 245</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                                <span class="item_price">$230.00</span>
                                                <del>$280.00</del>
                                ...
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/')}}/front-end/images/m8.jpg" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{url('/single')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{url('/single')}}">BPL Washing Machine</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                ...
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/')}}/front-end/images/m9.jpg" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{url('/single')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{url('/single')}}">Microwave Oven</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                    ...
                    <div class="side-bar p-sm-4 p-3">
                        ...
                        <div class="range border-bottom py-2">
                            ...
                            <div class="w3l-range">
                                ...
                                <ul>
                                    <li>
                                        <a href="{{url('/',['type'=>'range', 'min'=>'1', 'max'=>'100']) }}">$1 - $100</a>
                                    </li>
                                    <li>
                                        <a href="{{url('/',['type'=>'range', 'min'=>'101', 'max'=>'300']) }}">$101 - $300</a>
                                    </li>
                                    <li>
                                        <a href="{{url('/',['type'=>'range', 'min'=>'301', 'max'=>'500']) }}">$301 - $500</a>
                                    </li>
{{--                                    @foreach($products as $product)--}}
{{--                                        <li>--}}
{{--                                            <a href="{{url('/',['id'=>$product->id,'type'=>'range', 'min'=>'1', 'max'=>'100']) }}">$1,000</a>--}}
{{--                                        </li>--}}
{{--                                    @endforeach--}}
                                ...
                                <div class="scroll">
                                    <div class="row">
                                        <div class="col-lg-3 col-sm-2 col-3 left-mar">
                                            <img src="{{asset('/')}}/front-end/images/k1.jpg" alt="" class="img-fluid">
                                        </div>
                                    ...
                                    <div class="row my-4">
                                        <div class="col-lg-3 col-sm-2 col-3 left-mar">
                                            <img src="{{asset('/')}}/front-end/images/k2.jpg" alt="" class="img-fluid">
                                        </div>
                                        <div class="col-lg-9 col-sm-10 col-9 w3_mvd">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-sm-2 col-3 left-mar">
                                            <img src="{{asset('/')}}/front-end/images/k3.jpg" alt="" class="img-fluid">
                                        </div>
                                        <div class="col-lg-9 col-sm-10 col-9 w3_mvd">
