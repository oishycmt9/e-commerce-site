            ...
            <div class="col-md-3 logo_agile">
                <h1 class="text-center">
                    <a href="{{url('/')}}" class="font-weight-bold font-italic">
                        <img src="{{asset('/')}}/front-end/images/logo2.png" alt=" " class="img-fluid">Electro Store
                    </a>
                </h1>
            </div>
            <!-- //logo -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6 multi-gd-img">
                                        <ul class="multi-column-dropdown">
                                            @foreach($categories as $category)
                                            <li>
                                                <a href="{{url('/', ['id'=>$category->id, 'type'=>'category'])}}">{{$category->name}}</a>
                                            </li>
                                            @endforeach
                                        </ul>
                                    </div>
...
{{--                                            </li>--}}
                    ...
                    <li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{url('/product')}}">Product 1</a>
                            <a class="dropdown-item" href="product2.html">Product 2</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{url('/single')}}">Single Product 1</a>
                            <a class="dropdown-item" href="single2.html">Single Product 2</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{url('/checkout')}}">Checkout Page</a>
                            <a class="dropdown-item" href="{{url('/payment')}}">Payment Page</a>
                        </div>
                    </li>
                    <li class="nav-item">
    ...
    <div class="agile-sometext py-md-5 py-sm-4 py-3">
        <div class="container">
            ...
            <div class="sub-some child-momu mt-4">
                ...
                <ul>
                    <li>
                        <img src="{{asset('/')}}/front-end/images/pay2.png" alt="">
                    </li>
                    <li>
                        <img src="{{asset('/')}}/front-end/images/pay5.png" alt="">
                    </li>
                    <li>
                        <img src="{{asset('/')}}/front-end/images/pay1.png" alt="">
                    </li>
                    <li>
                        <img src="{{asset('/')}}/front-end/images/pay4.png" alt="">
                    </li>
                    <li>
                        <img src="{{asset('/')}}/front-end/images/pay6.png" alt="">
                    </li>
                    <li>
                        <img src="{{asset('/')}}/front-end/images/pay3.png" alt="">
                    </li>
                    <li>
                        <img src="{{asset('/')}}/front-end/images/pay7.png" alt="">
                    </li>
                    <li>
                        <img src="{{asset('/')}}/front-end/images/pay8.png" alt="">
                    </li>
                    <li>
                        <img src="{{asset('/')}}/front-end/images/pay9.png" alt="">
                    </li>
                </ul>
            </div>
            <!-- //payment -->
